...
void Biseccion(){
    ...
    while(i<=Nmax){
        ...
        if((signo(Funcion(a))*signo(Funcion(p)))<0){ //Hacemos el intervalo mas pequeño, para esto se verifica si a o b tomaran el valor de p
            b=p;   
        }else a=p;
