...
void LeerArchivo2(const char *, float A[]);
void FuncionEliminacionGPP(int n, int col, float A[]);
void Imprimir1(int n,int col,float A[]);
float *Sustitucion2(int n, int col, float A[]);
...
void EliminacionGPP()
{
    ...
    const char *archivo = str.c_str(); //Transformamos el string en const char * 
   	...
   	LeerArchivo2(archivo, A);    
    cout<<"La matriz capturada es:\n";
    Imprimir1(n,n+1,A);
     
    FuncionEliminacionGPP(n,col,A);
    cout<<"\nAplicando eliminacion gaussiana con pivoteo:\n";
    Imprimir1(n,n+1,A);
    
    X=Sustitucion2(n,col,A); 
...
/*
    ...
    SALIDA: ----
*/
void LeerArchivo2(const char * archivo, float A[])
{    
...
/*
    ...
    SALIDA: ----
*/
void Imprimir1(int r,int col, float A[])
{
   int j,i;
   cout<<char(218);
